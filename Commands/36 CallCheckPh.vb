<Command("Call Check pH", , , , "2"),
 TranslateCommand("zh-TW", "呼叫pH偵測"),
 Description("Call Check pH"),
 TranslateDescription("zh-TW", "呼叫pH偵測")>
Public NotInheritable Class Command36
    ...
    With ControlCode
      Select Case State
        ...
        Case S36.WaitTime
          ...
          State = S36.WaitCallAck2

        Case S36.WaitCallAck2
          If .FlashFlag2 Then
            StateString = If(.Language = LanguageValue.ZhTw, "呼叫手動加染料", "Call Manual Add Dyes")
          Else
...
#Region "Standard Definitions"
  ...
  Friend ReadOnly Property IsOn() As Boolean Implements ACCommand.IsOn
    Get
      Return State <> S36.Off
    End Get
  End Property
  Public ReadOnly Property IsCalling() As Boolean
    Get
      Return (State = S36.WaitCallAck)
    End Get
  End Property

  <EditorBrowsable(EditorBrowsableState.Advanced)> Private state_ As S36
  Public Property State() As S36
    Get
      Return state_
    End Get
    Private Set(ByVal value As S36)
      state_ = value
    End Set
  End Property
#End Region
...
Partial Public Class ControlCode
  Public ReadOnly Command36 As New Command36(Me)
End Class
#End Region
