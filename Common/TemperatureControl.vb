Public Class TemperatureControl
  ...
  <Translate("zh", "超溫")> Public Alarms_TemperatureHigh As Boolean
  <Translate("zh", "溫度不足")> Public Alarms_TemperatureLow As Boolean
  ...
  <Translate("zh", "TC:升溫比例參數"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(45)> _
    Public Parameters_HeatPropBand As Integer = 200
  <Translate("zh", "TC:升溫積分參數"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(250)> _
    Public Parameters_HeatIntegral As Integer = 250
  <Translate("zh", "TC:升溫最大斜率"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(60)> _
    Public Parameters_HeatMaxGradient As Integer = 50
  <Translate("zh", "TC:升溫到達溫度"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(10)> _
    Public Parameters_HeatStepMargin As Integer = 10

  'PID Cooling Parameters - pass to PID while temperature state = cooling
  <Translate("zh", "TC:降溫比例參數"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(10)> _
    Public Parameters_CoolPropBand As Integer = 200
  <Translate("zh", "TC:降溫積分參數"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(250)> _
    Public Parameters_CoolIntegral As Integer = 250
  <Translate("zh", "TC:降溫最大斜率"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(50)> _
    Public Parameters_CoolMaxGradient As Integer = 80
  <Translate("zh", "TC:降溫到達溫度"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(10)> _
...
#End If
  ...
  <Translate("zh", "TC:升降溫模式"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(0)> _
    Public Parameters_HeatCoolModeChange As Integer = 0

  <Translate("zh", "TC:警報溫度"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(50), Unit(Unit.TemperatureTenths)> _
    Public Parameters_TemperatureAlarmBand As Integer = 30
  <Translate("zh", "TC:警報時間"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(120), Unit(Unit.Seconds)> _
    Public Parameters_TemperatureAlarmDelay As Integer = 30

  <Translate("zh", "TC:PID停止運算"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(120)> _
    Public Parameters_TemperaturePidPause As Integer = 50
  <Translate("zh", "TC:PID重新運算"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(20)> _
    Public Parameters_TemperaturePidRestart As Integer = 80
  <Translate("zh", "TC:PID重設"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(150)> _
    Public Parameters_TemperaturePidReset As Integer = 100
  <Translate("zh", "TC:升溫等待時間"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(10), Unit(Unit.Seconds)> _
    Public Parameters_HeatVentTime As Integer
  <Translate("zh", "TC:降溫等待時間"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(10), Unit(Unit.Seconds)> _
    Public Parameters_CoolVentTime As Integer

  <Translate("zh", "TC:急速降溫到達溫度"), Category("Temperature Control"), TranslateCategory("zh", "溫度控制"), DefaultValue(800), Unit(Unit.TemperatureTenths)> _
