<Command("LiquidRatio", "LR |1-99| ", , , , CommandType.BatchParameter),
 TranslateCommand("zh-TW", "浴比", "浴比 |1-99|")>
  ...
  Public Function Start(ByVal ParamArray param() As Integer) As Boolean Implements ACCommand.Start
    With ControlCode
      .TemperatureControlFlag = True
            .LiquidRatio = param(1)
            If .LiquidRatio > 0 Then
                .LiquidRatioWas = .LiquidRatio
            Else
                .LiquidRatio = .LiquidRatioWas
            End If
      State = S22.Off
    End With
  End Function
