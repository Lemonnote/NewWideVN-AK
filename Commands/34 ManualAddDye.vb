<Command("Manual Add Dye", , , , "2"),
 TranslateCommand("zh-TW", "呼叫手動加染料"),
 Description("Manual Add Dye"),
 TranslateDescription("zh-TW", "呼叫手動加染料")>
    ...
    With ControlCode
      Select Case State
        ...
        Case S34.WaitTime
          ...
          State = S34.WaitCallAck2

        Case S34.WaitCallAck2
          If .FlashFlag2 Then
            StateString = If(.Language = LanguageValue.ZhTw, "呼叫手動加染料", "Call Manual Add Dyes")
          Else
