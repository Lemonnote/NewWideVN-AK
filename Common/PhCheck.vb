Public Class PhCheck_
    ...
    Public Sub Run()
        ...
        Wait1.TimeRemaining = .PhSamplingTime
        PhCheckBefore(X) = .PhControl.ExpectPh
          ...
          DelayWait.TimeRemaining = .DoublePhSample
          State = PhCheck.DelayCheck2
                ...
                Case PhCheck.DelayCheck2
                    ...
                    '-------------------------------------------------------載入每段"取樣時間"
                Case PhCheck.Check1
          Wait.TimeRemaining = .PhSamplingTime
...
#Region "Standard Definitions"
    ...
    '   <GraphTrace(1, 1200, 500, 3500, "Blue", "%2tpH"), Translate("zh", "PH設定值")> _
