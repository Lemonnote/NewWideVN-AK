...
stateComplete:
          ...
          If work_.StationNumber <> stationAddress OrElse work_.StartRegister <> firstRegister _
    ...
    Public Function Read(ByVal stationNumber As Integer, ByVal startRegister As String, ByVal values As Array) As Result
      ...
      RunStateMachine(stationNumber, startRegister, True)
          ...
          Case Else
            ...
            Else
              ...
              Else
                ...
                For i As Integer = 0 To count - 1
                  shortArray(i + 1) = BitConverter.ToUInt16(BitConverter.GetBytes(data(i)), 0)
                Next i
              End If
            End If
        End Select
          ...
          Case Else
            ...
            Else
              ...
              Else
                ...
                For i = 0 To count - 1
                  data(i) = BitConverter.ToUInt16(BitConverter.GetBytes(valuesArray(i + 1)), 0)
                Next i
              End If
            End If
