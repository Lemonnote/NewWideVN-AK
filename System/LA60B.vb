Namespace Ports
  Public Class LA60B
    ...
    Private Shared Function ToHex1Byte(value As Integer) As Byte
      Return Convert.ToByte(If(value < 10, 48 + value, 65 + value - 10))
    End Function
    Private Shared Function ToHex4Bytes(value As UShort) As Byte()
      Dim ret(4 - 1) As Byte
      For i = 0 To 4 - 1
      ...
      Return ret
    End Function
    Private Shared Function FromHex4Bytes(value() As Byte, index As Integer) As UShort
      Dim ret As UShort
      For i = 0 To 4 - 1
      ...
      Return ret
    End Function
    Private Shared Function FromHex1Byte(value As Byte) As Byte
      If value <= 57 Then Return CType(value - 48, Byte)
      Return CType(value - 65 + 10, Byte)
    End Function

    Private Sub BeginWriteAndRead(stationNumber As Integer, commandCode As Integer, tx() As Byte, rxCount As Integer)
    ...
    Private Sub RunStateMachine() ' stationAddress As Integer, firstRegister As String, isRead As Boolean)
      Select Case state_
        Case State.Tx
...
stateRx:
    ...
    Function Read(stationNumber As Integer, startRegister As String, values As Array) As Result
    ...
    Function Write(stationNumber As Integer, startRegister As String, values As Array, writeMode As WriteMode) As Result
      If state_ = State.Idle Then
        ...
        If writeMode = Ports.WriteMode.Optimised AndAlso _
           writeOptimisation_.RecentlyWritten(values, stationNumber, startRegister) Then Return Result.OK
      ...
      If result_ = Result.OK AndAlso writeMode = Ports.WriteMode.Optimised Then
        writeOptimisation_.SuccessfulWrite(values, stationNumber, startRegister)
      End If
      state_ = State.Idle
      Return result_
    End Function

    Private Shared Function RegisterLength(value As String) As Integer
      Select Case value.Chars(0)
        Case "X"c, "Y"c, "M"c, "S"c, "T"c, "C"c : Return 5
        Case Else : Return 6
      End Select
    End Function
    Private Shared Function RegisterToString(value As String) As String
      Dim regTypeLen = 1
      Do
    ...
    Private Shared Function ToUShort(value() As Boolean, startIndex As Integer, length As Integer) As UShort
      Dim ret As UShort
