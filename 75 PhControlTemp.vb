<Command("PhControlTemp", "TARGET PH |4-9|.|00-99|", , , "", CommandType.ParallelCommand), _
 TranslateCommand("zh-TW", "PH值平行控制-溫度", "PH值設定 |4-9|.|00-99|"), _
...
Public NotInheritable Class Command75
    ...
    Public Function Start(ByVal ParamArray param() As Integer) As Boolean Implements ACCommand.Start
        With ControlCode
            '--------------------------------------------------------------------------------------------------------PH用
            .PhWash.Cancel() : .Command73.Cancel() : .Command76.Cancel() : .Command74.Cancel() : .Command77.Cancel()
            '---------------------------------------------------------------------------------------------------------
    ...
    Public Function Run() As Boolean Implements ACCommand.Run
        With ControlCode
            Select Case State
                Case S75.Off
                    If .Command74.State = Command74.S74.Off And .Command76.State = Command76.S76.Off And .Command77.State = Command77.S77.Off Then
                        .PhControlFlag = False
                    End If
